...
# Announce winner
title @e[type=minecraft:player] title {"text":"RED TEAM WINS!!","color":"red"}
...
# schedule redwin.mcfunction for 15 ticks after the game winning kill since a schedule can't be done in tick.mcfunction
schedule function halo:setup/red/redwin 15
