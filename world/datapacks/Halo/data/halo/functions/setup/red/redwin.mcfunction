...
# Set Blue team spawnpoint to losers podium
spawnpoint @e[type=minecraft:player,team=Blue] 107 59 190 -90

# Set RED team spawnpoint to winners podium
spawnpoint @e[type=minecraft:player,team=Red] 129 59 190 90
...
scoreboard players reset #red PlayerKills
scoreboard players reset #red TeamPoints

# Turn on Red Beacon above lobby
setblock 226 47 183 air replace

# TP Red team to winners podium and Blue team to losers podium
tp @e[team=Blue] 107 59 190 -90 0
tp @e[team=Red] 129 59 190 90 0
...
# Schedule Fireworks
schedule function halo:setup/red/redfireworks 60
schedule function halo:setup/red/redfireworks 70 append
schedule function halo:setup/red/redfireworks 80 append
schedule function halo:setup/red/redfireworks 90 append
